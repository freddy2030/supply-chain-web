...
const ProportionSales = ({
  ...
  <Card
    ...
    title={
      <FormattedMessage
        id="data_statistics.analysis.the-proportion-of-sales"
  ...
  >
    <div>
      <h4 style={{ marginTop: 8, marginBottom: 32 }}>
        <FormattedMessage id="data_statistics.analysis.sales" defaultMessage="Sales" />
      </h4>
      <Pie
        hasLegend
        subTitle={<FormattedMessage id="data_statistics.analysis.sales" defaultMessage="Sales" />}
